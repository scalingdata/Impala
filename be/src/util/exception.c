...
// Copied from:
//   https://github.com/apache/hadoop/blob/release-2.7.1/hadoop-hdfs-project/hadoop-hdfs/src/main/native/libhdfs/exception.c
...
// All we changed in this file is some #includes, we don't define a method we didn't need, and added this comment block.

#include "exception.h"
#include "jni_helper.h"

#include <stdlib.h> // gets rid of a compiler warning: incompatible implicit declaration of built-in function ‘free’
#include <string.h> // gets rid of a compiler warning: incompatible implicit declaration of built-in function ‘strdup’
#include <errno.h> // defines ENOENT, EACCESS, etc.
#include <hdfs.h> // defines EINTERNAL
