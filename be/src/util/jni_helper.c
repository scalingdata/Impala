...
// Copied from:
//   https://github.com/apache/hadoop/blob/release-2.7.1/hadoop-hdfs-project/hadoop-hdfs/src/main/native/libhdfs/jni_helper.c
...
// In this file we changed some #includes, removed some methods we didn't need (and added this comment block).
