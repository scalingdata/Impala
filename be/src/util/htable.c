...
// Copied from
//   https://github.com/apache/hadoop/blob/release-2.7.1/hadoop-hdfs-project/hadoop-hdfs/src/main/native/libhdfs/common/htable.c
...
// All we changed in this file is we addded #include "htable.h" and this comment block.
